...
for p in [3]:  
    ...
    for i in range(0,iteration):
        ...
        FPSaveDir = "./data/normal_data/FP_rule/" + protocol_name + "/" + protocol_name + "_FP" + iter
        ...
        clusterCenSaveDir = "./output/AS_check/" + protocol_name + "/random_test/" + protocol_name + "_FP_cluster" + iter
