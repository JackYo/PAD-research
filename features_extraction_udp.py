...
ruleset = dict()
for rule in rule.parse_file("C:/Users/Chiao/python_work/My_CNN/data/BACnet_packet_AS_spec.txt"):
...
pcap = ppcap.Reader(filename="C:/Users/Chiao/python_work/My_CNN/data/normal_data/BACnet_Host_spec.pcap")
saveDir = "./output/bacnet_feature_byte_seq"
                ...
                for i in range(lowbound, upbound, 2):
                    ...
                    if checkout == refined_content:
                        ...
                        if out[0:i] != '':
                            ...
                            print("\t\t\t rem1 = %s" % rem1)
                            f.write(str(rem1))
                            f.write( " # [{}] {} matched before? {}\n".format(ruleid,refined_content,match) )
...
f.write("\n# normal_count = {}\n".format(normal_count) )
f.write("# match_count = {} ".format(match_count) )
